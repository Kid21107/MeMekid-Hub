...
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kid21107/KID-HUB/main/newui2.lua"))()
local Window = redzlib:MakeWindow({ Title = "Kid Hub : Meme Sea", SubTitle = "by Kid", SaveFolder = "redzHub-MemeSea.json" })
