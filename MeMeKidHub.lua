...
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kid21107/MeMekid-Hub/main/ui.lua"))()
local Window = redzlib:MakeWindow({ Title = "MeMeKid Hub : Meme Sea", SubTitle = "by Hungdz", SaveFolder = "MeMeKidHub-MemeSea.json" })
